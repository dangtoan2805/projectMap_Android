...
import com.app.final03.Main.RecyclerView.Adapter_RecyclerView;
import com.app.final03.Map.Map;
import com.app.final03.Model.Place;
import com.app.final03.MyPlaces_Fragment.My_Places;
import com.app.final03.R;
import com.app.final03.Search_Fragment.Search;
...
public class MainActivity extends AppCompatActivity implements
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_about:{
                Toast.makeText(this, "Design by VietToan :)", Toast.LENGTH_SHORT).show();
                return true;
            }
            case R.id.nav_exit:{
                AlertDialog.Builder builder = new AlertDialog.Builder(this);
